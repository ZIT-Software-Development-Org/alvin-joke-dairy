...
jokesRouter.put("/jokes/:id", isOwnerOrAdmin, updateJoke); // Update a joke (authenticated + ownership check)
...
jokesRouter.delete("/comments/:commentId", isOwnerOrAdmin, deleteComment); // Delete a comment (authenticated + ownership check)

// Like routes
jokesRouter.post("/jokes/:jokeId/like", isAuthenticated, likeJoke); // Like a joke (authenticated)
jokesRouter.delete("/jokes/:jokeId/like", isOwnerOrAdmin, unlikeJoke); // Unlike a joke (authenticated)
